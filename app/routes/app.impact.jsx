      ...
      <div className="grid grid-cols-4 gap-5 mt-8">
        ...
        {metrics.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className="glass-card h-40 w-full rounded-2xl p-5 flex flex-col justify-between"
            >
              <div className="w-10 h-10 bg-white rounded-xl flex items-center justify-center ">
                <Icon size={18} className={METRIC_COLORS[item.title] || ""} />
              </div>
              <div className="text-on-surface font-headline-sm ">
                {item.title}
              </div>
              <div className="text-on-surface font-semibold">{item.value}</div>
              <div className="text-on-surface font-mono-sm text-[12px]">
                {item.subtitle}
              </div>
            </div>
          );
            ...
            <div className="space-y-3">
              {beforeData.map((item, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <p className="text-primary font-semibold text-mono-sm text-[16px]">
                    {item.value}
                  </p>
                </div>
              ))}
              ...
              {afterData.map((item, index) => (
                <div key={index} className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <p className="text-primary font-semibold font-mono text-[16px]">
                      {item.value}
                    </p>
                    {item.change && (
