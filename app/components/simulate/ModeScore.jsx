            ...
            <div className="rounded-2xl border border-outline-variant bg-surface-container-low p-5">
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p
                    className={`text-4xl font-black leading-none ${scoreColor}`}
                  >
                ...
                {result.visibility && (
                  <LikelihoodBadge value={result.visibility} />
                )}
              </div>
            </div>
              ...
              <ResultCard label="Matched Signals" labelColor="text-green-win">
                <div className="flex flex-wrap gap-2 mt-1">
                  {result.matchedAttributes.map((a) => (
                    <span
                      key={a}
                      className="rounded-full border border-[#00e29e]/25 bg-[#00e29e]/10 px-3 py-1 text-xs font-semibold text-green-win"
                    >
                      ✓ {a}
                    </span>
                  ))}
